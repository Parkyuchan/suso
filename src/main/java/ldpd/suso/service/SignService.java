...
public class SignService {
    ...
    public void registerSign(Sign sign, MultipartFile videoFile) throws Exception {  //등록할 수어를 db에 저장
        if (videoFile != null && !videoFile.isEmpty() && !sign.getTitle().isEmpty() && !sign.getSign_desc().isEmpty()) {
